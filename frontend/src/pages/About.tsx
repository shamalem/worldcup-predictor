    ...
    <div>
      ...
      <div className="card">
        ...
        <ol className="reasons">
          ...
          <li><span className="num">6</span><span><b>Plain-language reasons</b> — the strongest feature contributions are turned into readable sentences (no LLM), so every prediction comes with a transparent "why".</span></li>
        </ol>
      </div>
