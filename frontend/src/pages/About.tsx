    ...
    <div>
      ...
      <div className="card">
        ...
        <ol className="reasons">
          ...
          <li><span className="num">6</span><span><b>Scoreline model</b> — a separate Poisson + Dixon-Coles model whose attack/defence strengths are fitted over <i>all</i> internationals (recency-weighted), with the goal split anchored to opponent-adjusted Elo, estimates each side's expected goals and produces a probability for every scoreline.</span></li>
        </ol>
      </div>
